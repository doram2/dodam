...
public class LibraryController {
	...
	public void fileDown(@RequestParam(value="sfile") String sfileName, @RequestParam(value="ofile") String ofileName,
						HttpServletRequest request, HttpServletResponse response) {
		fileDownLoadService.execute(sfileName, ofileName, request, response);
	}
	
	@RequestMapping("libDelete")
	public String libDelete(LibraryCommand libraryCommand, 
	...
	public String libModify(@RequestParam(value="libNum") String libNum, @RequestParam(value="libPw")
							String libPw, Model model, HttpSession session) {
		model.addAttribute("newLineChar", '\n');
		String path = libraryModifyService.execute(libNum,libPw,model,session);
		return path;
	}
	@RequestMapping("libInfo")
	public String libInfo(@RequestParam(value="num") String libNum, Model model, HttpSession session) {
		model.addAttribute("newLineChar", '\n');
