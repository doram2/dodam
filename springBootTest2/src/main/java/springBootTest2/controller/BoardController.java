...
public class BoardController {
	...
	@Autowired
	BoardInfoService boardInfoServie;
	@Autowired
	...
	public String boardUpdate(HttpServletRequest request) {
		boardInfoServie.execute(request);
	...
	public String boardDetail(@RequestParam(value = "num") Integer boardNum, Model model, HttpServletRequest request) {
